...
class Player(AbstractUser):
    ...
    tournament_name = models.CharField(max_length =30,blank=True, unique=True, null=True)
    display_name = models.CharField(max_length=30 ,blank=True, unique=True, null=True)
